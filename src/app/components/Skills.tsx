    ...
    return ( 
        <main className="grid gap-5">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
               <div className="flex items-center justify-center gap-5 shadow-sm shadow-jet rounded-lg border border-jet border-solid p-3 md:py-5 md:px-2">
                    <FaHtml5 className="text-3xl text-vegas-gold"/>
                    <h1 className="text-litewhite text-sm md:text-lg font-bold">HTML</h1>
               </div>

               <div className="flex items-center justify-center gap-5 shadow-sm shadow-jet rounded-lg border border-jet border-solid p-3 md:py-4 md:px-2">
