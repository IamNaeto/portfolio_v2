...
const NavBar = () => {
    ...
    return (
        <header className="fixed xl:absolute bottom-0 xl:bottom-auto left-0 xl:left-auto xl:top-0 xl:right-0 flex items-center xl:items-end justify-center xl:justify-end xl:bg-none w-full xl:w-[400px] rounded-lt-xl  rounded-rt-xl z-50">
            <nav className="relative flex items-center justify-center text-[16px] font-medium text-litewhite gap-7 xl:gap-10 rounded-bl-none xl:rounded-bl-xl rounded-tr-xl xl:rounded-tr-lg rounded-tl-xl xl:rounded-tl-none  border border-jet border-solid p-4 bg-smoky-gray shadow-sm w-full z-36">
