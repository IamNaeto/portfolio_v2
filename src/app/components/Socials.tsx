        ...
        <main className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="flex flex-col items-center justify-center gap-5 p-4 rounded-lg shadow-sm shadow-jet border border-jet border-solid bg-smoky-black" data-aos="fade-down">
                    ...
                    <a href="mailto:egesionucharlesobimnaeto@gmail.com" target="_blank">
                        <h4 className="text-[13px] md:text-[14px] text-litewhite hover:text-vegas-gold transition-all delay-200">Send A Mail</h4>
                    </a>
                </div>
                ...
                <div className="flex flex-col items-center justify-center gap-5 p-4 rounded-lg shadow-sm shadow-jet border border-jet border-solid bg-smoky-black" data-aos="fade-down">
                    ...
                    <a href="https://wa.me/2348178200220" target="_blank">
                        <h4 className="text-[13px] md:text-[14px] text-litewhite hover:text-vegas-gold transition-all delay-200">Send A Message</h4>
                    </a>
                </div>
                ...
                <div className="flex flex-col items-center justify-center gap-5 p-4 rounded-lg shadow-sm shadow-jet border border-jet border-solid bg-smoky-black" data-aos="fade-down">
                    ...
                    <a href="tel:+2348147371491" target="_blank">
                        <h4 className="text-[13px] md:text-[14px] text-litewhite hover:text-vegas-gold transition-all delay-200">Place A Call</h4>
                    </a>
                </div>
                ...
                <div className="flex flex-col items-center justify-center gap-5 p-4 rounded-lg shadow-sm shadow-jet border border-jet border-solid bg-smoky-black" data-aos="fade-down">
                    ...
                    <h4 className="text-[13px] md:text-[14px] text-litewhite transition-all delay-200">Imo State, Nigeria</h4>
                </div>
        </main>
     );
}
