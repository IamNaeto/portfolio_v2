            ...
            <section className="flex flex-col gap-5">
                ...
                <div className="relative pl-8 pr-4 border-l-[2px] border-l-jet border-l-solid ml-5 md:ml-8 mt-10 mb-10 grid gap-6">
                    ...
                    <div className="relative grid gap-2">
                        <h3 className="text-[16px] md:text-[18px] text-litewhite font-bold" data-aos="fade-down">Nnamdi Azikiwe University Awka, Nigeria</h3>
                        <h4 className="text-[15px] md:text-[17px] text-litewhite" data-aos="fade-down">Faculty of Basic Medical Sciences</h4>
                        <h4 className="text-[14px] md:text-[16px] text-litewhite font-bold font-italic" data-aos="fade-down">Bachelor of Science, Anatomy</h4>
                        <p className="text-[14px] md:text-[16px] text-vegas-gold" data-aos="fade-down">2016 - 2021</p>
                    ...
                    <div className="relative grid gap-2">
                        ...
                        <h4 className="text-[14px] md:text-[16px] text-litewhite font-bold font-italic" data-aos="fade-down">Full - Stack Software Engineer - Frontend</h4>
                ...
                <div className="relative pl-8 pr-4 border-l-[2px] border-l-jet border-l-solid ml-5 md:ml-8 mt-10 mb-10 grid gap-6">
                    ...
                    <div className="relative grid gap-2">
                        <h3 className="text-[17px] md:text-[18px] text-litewhite font-bold" data-aos="fade-down">HNG Internship Training</h3>
                        <h4 className="text-[14px] md:text-[16px] text-litewhite" data-aos="fade-down">React, NextJS, Typescript, TailwindCSS</h4>
                        <h4 className="text-[15px] md:text-[17px] text-litewhite font-bold font-italic" data-aos="fade-down">HNGx Finalist - Frontend Developer Intern</h4>
                ...
                <div className="relative pl-8 pr-4 border-l-[2px] border-l-jet border-l-solid ml-5 md:ml-8 mt-10 mb-10 grid gap-6">
                    ...
                    <div className="relative grid gap-2">
                        <h3 className="text-[16px] md:text-[18px] text-litewhite font-bold" data-aos="fade-down">Let&apos;s Upgrade</h3>
                        <h4 className="text-[14px] md:text-[16px] text-litewhite" data-aos="fade-down">Python Programming Essentials</h4>
                        <h4 className="text-[14px] md:text-[16px] text-litewhite" data-aos="fade-down">JavaScript Programming Essentials</h4>
                        <h4 className="text-[14px] md:text-[16px] text-litewhite" data-aos="fade-down">HTML/CSS Programming Essentials</h4>
                        <p className="text-[14px] md:text-[16px] text-vegas-gold" data-aos="fade-down">2022</p>
                    ...
                    <div className="relative grid gap-2">
                        <h3 className="text-[16px] md:text-[18px] text-litewhite font-bold" data-aos="fade-down">Great Learning</h3>
                ...
                <div className="relative pl-8 pr-4 border-l-[2px] border-l-jet border-l-solid ml-5 md:ml-8 mt-10 mb-10 grid gap-6">
                    ...
                    <div className="relative grid gap-2">
                        ...
                        <p className="text-[14px] md:text-[16px] text-vegas-gold" data-aos="fade-down">2023 till date</p>
