...
const ProfileBar = () => {
    ...
    return (
        <aside className="relative xl:fixed w-full xl:w-[24%] bg-eerie-black rounded-lg border border-jet border-solid shadow-sm shadow-jet p-5 flex flex-col gap-4 mt-5 md:mt-0">
