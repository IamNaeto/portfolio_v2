...
const ProfileBar = () => {
    ...
    return (
        <aside className="relative xl:fixed w-full xl:w-[23%] bg-eerie-black rounded-lg border border-jet border-solid shadow-sm shadow-jet p-5 flex flex-col gap-4 mt-5 md:mt-0">
            <div className="flex flex-row xl:flex-col items-center justify-start xl:justify-center gap-4">
                ...
                <div className="flex flex-col items-start xl:items-center gap-2">
                    ...
                    <a href="" className="py-2 px-3 md:px-5 rounded-md text-smoky-black hover:text-vegas-gold bg-vegas-gold hover:bg-smoky-black hover:border-jet border border-solid text-[13px] md:text-[16px] font-bold transition-all delay-200 flex items-center justify-center">Resume <HiOutlineCloudDownload className="ml-1 animate-bounce"/> </a>
                </div>
            </div>
            <div className={`${isMenuOpen ? 'flex' : 'hidden'} xl:flex flex-col gap-4`}>
                ...
                <div className="flex items-center justify-center">
                    <div className="flex items-center justify-center gap-4">
                        ...
                        <a href=""><FaWhatsapp className="text-4xl p-2 rounded-xl bg-smoky-black hover:bg-jet transition-all delay-200 border border-jet border-solid  text-litewhite hover:text-vegas-gold font-medium" /></a>
                    </div>
                </div>
            </div>
